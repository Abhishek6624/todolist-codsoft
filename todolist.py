...
listbox_task=Listbox(frame_task,bg="green",fg="black",height=15,width=50,font = "Helvetica")  
...
#Button widget 
entry_button=Button(window,text="Add your task",bg="yellow",width=50,command=entertask)
entry_button.pack(pady=3)

delete_button=Button(window,text="Delete selected task",bg="yellow",width=50,command=deletetask)
delete_button.pack(pady=3)

mark_button=Button(window,text="Mark as completed ",bg="yellow",width=50,command=markcompleted)
